...
if __name__ == "__main__":
    ...
    result1 = evaluate_idiom_chain(
        real_example1["answer"], real_example1["ground_truth"])
    ...
    result2 = evaluate_idiom_chain(
        real_example2["answer"], real_example2["ground_truth"])
    ...
    result3 = evaluate_idiom_chain(
        real_example3["answer"], real_example3["ground_truth"])
    ...
    result4 = evaluate_idiom_chain(
        real_example4["answer"], real_example4["ground_truth"])
    ...
    result5 = evaluate_idiom_chain(
        real_example5["answer"], real_example5["ground_truth"])
